# Bits Orchestra Task I 
***
Two automated test cases,testing google form https://accounts.google.com/SignUp?service=mail
...
```
$ git clone https://github.com/Kar1stan/BitsOrchestraTaskI.git
